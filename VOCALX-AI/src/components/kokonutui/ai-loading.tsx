    ...
    <div className="flex items-center justify-center  w-full">
      <div className="space-y-4 w-auto">
        ...
        <div className="relative">
          ...
          >
            <div>
              {visibleLines.map((line, index) => (
                ...
                >
                  <div className="text-gray-600 dark:text-gray-500 pr-3 select-none w-6 text-right">
                    {line.number}
                  </div>
          ...
          <div
            className="absolute top-0 left-0 right-0 bottom-0 pointer-events-none rounded-lg from-gray-200/90 via-white/50 to-transparent dark:from-black/90 dark:via-black/50 dark:to-transparent"
            style={{
              background:
