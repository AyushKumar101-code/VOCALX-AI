                ...
                <div className={`${darkTheme ? "bg-gradient-to-br from-slate-800 to-slate-700" : "bg-gradient-to-br from-white to-blue-50/30"} rounded-lg`}>
                  ...
                  <div className={`px-5 py-4 border-b ${darkTheme ? "border-slate-700 bg-gradient-to-r from-slate-700 to-slate-600" : "border-blue-100 bg-gradient-to-r from-blue-50 to-blue-100/50"}`}>
                    <div className="flex items-center gap-2">
                      <FilterIcon className={`w-5 h-5 ${darkTheme ? "text-blue-400" : "text-blue-600"}`} />
              ...
              {filteredInterviews?.map((item: any, index: number) => {
                ...
                return (
                  <Card
                    ...
                    className={`relative rounded-2xl shadow-[0_8px_32px_-8px_rgba(59,130,246,0.1)] hover:shadow-[0_16px_48px_-12px_rgba(59,130,246,0.15)] hover:-translate-y-1.5 transition-all duration-300 p-6 w-full max-w-md flex flex-col justify-between group ${darkTheme
                  ...
                  >
                    ...
                    <CardHeader className="flex flex-row items-start justify-start gap-3 pb-2 relative z-10">
                      ...
                      <div className="flex flex-col gap-1 flex-1">
                        <p className={`text-xs uppercase tracking-[0.12em] font-semibold ${darkTheme ? "text-slate-400" : "text-slate-400"}`}>Role</p>
                    ...
                    <CardContent className={`text-sm font-inter pt-2 relative z-10 flex-1 flex flex-col gap-3 ${darkTheme ? "text-slate-300" : "text-slate-600"}`}>
                      <p className={`line-clamp-3 text-left leading-relaxed text-sm ${darkTheme ? "text-slate-300" : "text-slate-600"}`}>{item.jobDescription}</p>
                    ...
                    <div className={`h-px bg-gradient-to-r to-transparent my-3 relative z-10 ${darkTheme ? "from-transparent via-slate-600" : "from-transparent via-slate-200"}`} />
            ...
            <div className="mt-10 space-y-4">
              {filteredInterviews?.map((item: any, index: number) => {
                ...
                return (
                  <Card
                    key={item.interview_id}
                    className={`relative rounded-2xl shadow-[0_8px_32px_-8px_rgba(59,130,246,0.1)] hover:shadow-[0_16px_48px_-12px_rgba(59,130,246,0.15)] hover:translate-x-1 transition-all duration-300 p-5 w-full group ${darkTheme
                      ? "bg-gradient-to-r from-slate-800 via-slate-800 to-slate-700 border border-slate-700"
                      : "bg-gradient-to-r from-white via-white to-slate-50 border border-slate-200"
                      }`}
                  >
                    {/* Gradient Border Effect */}
                    ...
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 relative z-10">
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex flex-col gap-1">
                          ...
                          <p className={`line-clamp-2 text-sm leading-relaxed max-w-2xl ${darkTheme ? "text-slate-300" : "text-slate-600"}`}>
                            {item.jobDescription}
                          </p>
                      ...
                      <div className={`flex items-center gap-3 text-sm ${darkTheme ? "text-slate-300" : "text-slate-700"}`}>
                        <span className={`inline-flex items-center gap-2 rounded-lg bg-gradient-to-r px-3 py-1.5 font-semibold ${darkTheme
                          ? "from-slate-700 to-slate-600 text-slate-100"
                          : "from-slate-50 to-slate-100 text-slate-800"
                          }`}>
                          ⏱
                          <span className={darkTheme ? "text-slate-100" : "text-slate-800"}>{item.interviewDuration} mins</span>
                        </span>
                      </div>
                    </div>

                    <div className={`h-px bg-gradient-to-r to-transparent my-4 relative z-10 ${darkTheme ? "from-transparent via-slate-700" : "from-transparent via-slate-200"}`} />

                    <div className="flex flex-wrap items-center justify-between gap-4 relative z-10">
                      <div className={`flex items-center gap-2 text-sm ${darkTheme ? "text-slate-400" : "text-slate-500"}`}>
                      ...
                      <div className="flex items-center gap-3">
                        <Button
                          ...
                          className={`transition-all duration-200 flex items-center font-medium ${darkTheme
                            ? "bg-gradient-to-r from-blue-900 to-blue-800 text-blue-300 border border-blue-700 hover:from-blue-800 hover:to-blue-700 hover:border-blue-600 hover:text-blue-200"
                            : "bg-gradient-to-r from-blue-50 to-blue-100 text-blue-700 border border-blue-300 hover:from-blue-100 hover:to-blue-200 hover:border-blue-400 hover:text-blue-800"
                            }`}
                        >
